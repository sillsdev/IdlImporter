...
namespace SIL.IdlImporterTool
{
	...
	public class IdhCommentProcessor
	{
		...
		public class CommentInfo
		{
			...
			/// --------------------------------------------------------------------------------
			private static string TranslateHResultToException(string hresult)
			{
				#region HRESULTS
				switch (hresult)
				{
		...
		private readonly Dictionary<string, CommentInfo> m_Comments;
		...
		/// ------------------------------------------------------------------------------------
		private static void CleanupComments(Dictionary<string, CommentInfo> comments)
		{
